describe('Address validation', () => {
  ...
  it('fills currency and amount data', () => {
    ...
    cy.get(
      '[data-testid="vertical.step-amounts.amounts.currency-from-select.content.item-BTCB"]',
    ).click();
  ...
  it('validates addresses', () => {
    ...
    cy.get('[data-testid="vertical.step-amounts.receiving-address.native-input"]').type(
    ...
    cy.get('[data-testid="vertical.step-amounts.swap-btn"]').should('not.be.disabled');
  });

  it('invalidates form if "currencyOut" changes', () => {
    cy.get('[data-testid="vertical.step-amounts.amounts.currency-to-select.target"]').click();
    cy.get(
      '[data-testid="vertical.step-amounts.amounts.currency-to-select.content.item-BTCE"]',
    ).click();
    cy.get('[data-testid="vertical.step-amounts.swap-btn"]').should('be.disabled');
  });
});
