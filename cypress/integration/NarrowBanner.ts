describe('Narrow banner', () => {
  ...
  it('render correctly', () => {
    cy.visit('/');
    cy.percySnapshot('Narrow banner: after loading', { widths: [320] });
  });
  ...
  it('can switch coins', () => {
    ...
    cy.percySnapshot('Narrow banner: switch coin', { widths: [320] });
  ...
  it('can input address', () => {
    ...
    cy.percySnapshot('Narrow banner: address step', { widths: [320] });
  ...
  it('renders last step', () => {
    cy.percySnapshot('Narrow banner: submitted', { widths: [320] });
  });
});
